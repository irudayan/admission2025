                        ...
                        <div class="col-md-6">
                            {{-- <div class="form-group">
                                <label class="required"
                                    for="product_ids">{{ trans('cruds.leads.fields.products') }}</label>
                                <select class="form-control select2" name="product_ids[]" id="product_ids"
                                ...
                                <small
                                    class="form-text text-muted">{{ trans('cruds.leads.fields.products_helper') }}</small>
                            </div> --}}
