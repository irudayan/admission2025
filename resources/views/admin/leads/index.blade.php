...
@section('title', __('cruds.leads.title'))
@section('content')
    <p>&nbsp;</p>
    @if (session('success'))
        ...
        <div class="card-header">
            <div class="row align-items-center">
                <div class="col-lg-10 col-sm-10 col-md-10 col-xs-12">
                    <h5>{{ trans('cruds.leads.title_singular') }} {{ trans('global.list') }}</h5>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    {{-- <select class="form-control select2" name="product_ids[]" id="product_idss" multiple
                                        required>
                                        @foreach ($products as $product)
                                            <option value="{{ $product->id }}"
                                                {{ in_array($product->id, old('product_ids', [])) || (isset($lead) && $lead->products->contains('id', $product->id)) ? 'selected' : '' }}>
                                                {{ $product->name }}
                                            </option>
                                        @endforeach
                                    </select> --}}
